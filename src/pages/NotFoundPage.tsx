  ...
  return (
    <main className="isolate min-h-full">
      ...
      <div className="mx-auto max-w-7xl px-6 py-32 text-center sm:py-40 lg:px-8 relative z-10 flex flex-col items-center justify-center min-h-screen">
        <p className="text-base/8 font-semibold text-white">{text.error}</p>
        <h1 className="mt-4 text-5xl font-semibold tracking-tight text-balance text-white sm:text-7xl">{text.title}</h1>
        <p className="mt-6 text-lg font-medium text-pretty text-white/70 sm:text-xl/8 max-w-md text-balance">
          {text.description}
        </p>
        <div className="mt-10 flex justify-center">
          <Link to="/" className="text-lg font-normal text-white hover:text-white/90 transition-colors">
